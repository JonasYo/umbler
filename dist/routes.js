...
var _DeviceController = require('./app/controllers/DeviceController'); var _DeviceController2 = _interopRequireDefault(_DeviceController);

// validadores de dados
var _auth = require('./app/middlewares/auth/auth'); var _auth2 = _interopRequireDefault(_auth);
var _validateAuthFields = require('./app/middlewares/global/validateAuthFields'); var _validateAuthFields2 = _interopRequireDefault(_validateAuthFields);
var _validateCreateFields = require('./app/middlewares/user/validateCreateFields'); var _validateCreateFields2 = _interopRequireDefault(_validateCreateFields);
...
routes.get(
  '/services',
  _auth2.default,
  _ServicesController2.default.listServicesAvailable
);

routes.get(
  '/services/:date/schedule/:service_id',
  _auth2.default,
  _ServicesController2.default.listHoursAvailable
);

routes.get(
  '/schedule/user/:user_id',
  _auth2.default,
  _ScheduleController2.default.listUserSchedule
);

routes.get(
  '/schedule/:date/accredited/',
  _auth2.default,
  _ScheduleController2.default.listAccreditedSchedule
);

routes.post(
  '/services/:user_id/schedule',
  _auth2.default,
  _ScheduleController2.default.create
);
