...
var Schedules = function (_Model) {
  _inherits(Schedules, _Model);

  function Schedules() {
    _classCallCheck(this, Schedules);

    return _possibleConstructorReturn(this, (Schedules.__proto__ || Object.getPrototypeOf(Schedules)).apply(this, arguments));
  }

  _createClass(Schedules, null, [{
    key: 'init',
    value: function init(sequelize) {
      _get(Schedules.__proto__ || Object.getPrototypeOf(Schedules), 'init', this).call(this, {
